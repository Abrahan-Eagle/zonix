...
//         appBar: AppBar(
//           title: const Text('Ticket: Información Detallada'),
//           backgroundColor: isDarkMode ? const Color(0xFF4B39EF) : const Color(0xFF0078FF), 
//            foregroundColor: Colors.white, // Esto asegura que el texto sea blanco
//         ),
//         backgroundColor: isDarkMode ? Colors.black :  Colors.white ,
...
//                         style: TextStyle(
//                           fontFamily: 'Plus Jakarta Sans',
//                           color: Theme.of(context).brightness == Brightness.dark ? const Color(0xFF57636C) : Colors.black,
//                           fontSize: 16,
//                           fontWeight: FontWeight.w500,
//                         ),
//                       ),
...
//                           Center(
//                             child: CircularProgressIndicator(
//                               color: Theme.of(context).colorScheme.primary, // Color del indicador
//                             ),
//                           ),
//                           Image.network(
//                             ticket.gasCylinderPhoto,
...
// Widget _buildTimelineRow(BuildContext context, String label, String value, IconData icon, {bool success = false}) {
//   final theme = Theme.of(context);
