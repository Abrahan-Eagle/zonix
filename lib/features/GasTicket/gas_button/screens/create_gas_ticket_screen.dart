...
//                 ),
//                 if (_isExternal) ...[
//                   // Make the DropdownButton responsive
//                   Padding(
//                     padding: const EdgeInsets.symmetric(horizontal: 8.0),
//                     child: DropdownButtonFormField<int>(
//                       decoration: const InputDecoration(labelText: 'Selecciona una estación'),
...
//               ],
//               const SizedBox(height: 24),
//               // Responsive Dropdown for Gas Cylinders
//               Padding(
//                 padding: const EdgeInsets.symmetric(horizontal: 8.0),
//                 child: DropdownButtonFormField<int>(
//                   decoration: const InputDecoration(labelText: 'Selecciona una bombona'),
...
//                       });
//                     },
//                     validator: (value) => value == null ? 'Por favor, selecciona una estación' : null,
//                   ),
//                 ]
//               ],
//               const SizedBox(height: 24),
...
//               ),
//               const SizedBox(height: 24),
//               if (_isLoading) // Muestra el loading si está en proceso
//                 const Center(
//                   child: CircularProgressIndicator(),
//                 ),
//               if (!_isLoading) // Botón solo visible si no está en loading
//                 Center(
//                   child: ElevatedButton(
//                     onPressed: _submitForm,
//                     child: const Text('Crear Ticket'),
...
// //   bool _isLoading = false; // Variable de control de carga
...
// //   Future<void> _loadGasCylinders() async {
// //     setState(() {
// //       _isLoading = true; // Mostrar loading mientras se carga
// //     });
// //     try {
// //       final cylinders = await _ticketService.fetchGasCylinders(widget.userId);
// //       setState(() {
...
// //     } finally {
// //       setState(() {
// //         _isLoading = false; // Ocultar loading después de cargar
// //       });
// //     }
// //   }
...
// //   Future<void> _loadStations() async {
// //     setState(() {
// //       _isLoading = true; // Mostrar loading mientras se cargan las estaciones
// //     });
// //     try {
// //       final stations = await _ticketService.fetchStations();
// //       setState(() {
...
// //     if (_formKey.currentState!.validate()) {
// //       setState(() {
// //         _isLoading = true; // Mostrar loading mientras se crea el ticket
// //       });
// //       try {
// //         await _ticketService.createGasTicket(
// //           widget.userId,
...
// //       } finally {
// //         setState(() {
// //           _isLoading = false; // Ocultar loading después de la operación
// //         });
// //       }
// //     }
// //   }
...
// //               if (isSunday) ...[
// //                 CheckboxListTile(
// //                   title: const Text('¿Deseas comprar gas en una estación diferente a la asignada?'),
// //                   value: _isExternal,
// //                   onChanged: (value) {
// //                     setState(() {
// //                       _isExternal = value ?? false;
...
// // //     final bool isSunday = DateTime.now().weekday == DateTime.sunday;
// // //     final screenWidth = MediaQuery.of(context).size.width;
// // //     final isLargeScreen = screenWidth > 600; // Usamos 600px como un ejemplo de pantallas grandes

// // //     return Scaffold(
// // //       appBar: AppBar(title: const Text('Generar Ticket de Gas')),
// // //       body: SingleChildScrollView(
// // //         padding: EdgeInsets.symmetric(
// // //           horizontal: screenWidth * 0.05, // Margen lateral flexible
// // //           vertical: 16.0,
// // //         ),
// // //         child: Form(
// // //           key: _formKey,
...
// // //                 child: SvgPicture.asset(
// // //                   'assets/images/undraw_date_picker_re_r0p8.svg',
// // //                   height: isLargeScreen ? 250 : 200, // Ajustamos el tamaño de la imagen
// // //                 ),
// // //               ),
// // //               const SizedBox(height: 16),
// // //               const Text(
...
// // // //   try {
// // // //     final stations = await _ticketService.fetchStations();
// // // //     print("Stations fetched: $stations"); // Verifica si se cargan correctamente
// // // //     setState(() {
// // // //       _stations = stations;
// // // //     });
// // // //   } catch (e) {
...
// // // //           _selectedCylinderId!,
// // // //           _isExternal,
// // // //           _selectedStationId, // Aquí pasas la estación seleccionada
// // // //         );
// // // //         ScaffoldMessenger.of(context).showSnackBar(
// // // //           const SnackBar(content: Text('Ticket created successfully!')),
// // // //         );
...
// // // //                     items: _stations.map((station) {
// // // //                       return DropdownMenuItem<int>(
// // // //                         value: station['id'], // Verifica si 'id' es el campo correcto
// // // //                         child: Text(station['name']), // Verifica si 'name' es el campo correcto
// // // //                       );
// // // //                     }).toList(),
// // // //                     onChanged: (value) {
// // // //                       setState(() {
