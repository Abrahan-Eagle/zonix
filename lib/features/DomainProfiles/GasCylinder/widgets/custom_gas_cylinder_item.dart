...
class CustomGasSupplierItem extends StatefulWidget {
  ...
  @override
  _CustomGasSupplierItemState createState() => _CustomGasSupplierItemState();
}

class _CustomGasSupplierItemState extends State<CustomGasSupplierItem> {
