...
class UserProvider with ChangeNotifier {
  ...
  //     _profileCreated = (await _storage.read(key: 'profileCreated')) == 'true'; // Carga el estado de creación de perfil
...
Future<Map<String, dynamic>> getUserDetails() async {
  ...
  //     await _clearUserData(); // Asegurarse de limpiar datos almacenados
  //   } catch (e) {
